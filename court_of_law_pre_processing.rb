class CourtOfLawPreProcessing
  ...
  def stemming(texto)
     ...
     novo_texto = novo_texto.gsub(' danos ',' dano ')
     novo_texto = novo_texto.gsub(' profissionais ',' profissional ')
     novo_texto = novo_texto.gsub(' fiscais ',' fiscal ')
     novo_texto = novo_texto.gsub(' advocaticios ',' advocaticio ')
     novo_texto = novo_texto.gsub(' advocatícios ',' advocaticio ')
     novo_texto = novo_texto.gsub(' advocatício ',' advocaticio ')
     novo_texto = novo_texto.gsub(' honorarios ',' honorario ')
     novo_texto = novo_texto.gsub(' honorários ',' honorario ')
     novo_texto = novo_texto.gsub(' honorários ',' honorario ')
     novo_texto = novo_texto.gsub(' honorário ',' honorario ')
     novo_texto = novo_texto.gsub(' emprestimos ',' emprestimo ')
     novo_texto = novo_texto.gsub(' empréstimos ',' emprestimo ')
     novo_texto = novo_texto.gsub(' empréstimo ',' emprestimo ')
     novo_texto = novo_texto.gsub(' impostos ',' imposto ')
     novo_texto = novo_texto.gsub(' execuções ',' execucao ')
     novo_texto = novo_texto.gsub(' execução ',' execucao ')
     novo_texto = novo_texto.gsub(' municipios ',' municipio ')
     novo_texto = novo_texto.gsub(' municípios ',' municipio ')
     novo_texto = novo_texto.gsub(' município ',' municipio ')
     novo_texto = novo_texto.gsub(' tributário ',' tributaria ')
     novo_texto = novo_texto.gsub(' tributario ',' tributaria ')
     novo_texto = novo_texto.gsub(' tributária ',' tributaria ')
     novo_texto = novo_texto.gsub(' consignacao ',' consignado ')
